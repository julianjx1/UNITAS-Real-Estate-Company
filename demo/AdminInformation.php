...
<html lang="en">
    ...
    <body>   
        <div class="container" style="width: 100%; ">
            <div class="row">
                ...
                <div class="col-md-3 " style="padding:15px 0px 0px 50px; position: absolute;">
                    <h1 id="logo"><a class="navbar-brand " href="Admin%20Front page.html" style="color: white"><span>unitas </span> <span style="color: white"><i class="fas fa-building"></i></span><br>real estate ltd.</a></h1>
                </div>
                        ...
                        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1" >
                            <nav class="cl-effect-13" id="cl-effect-13">
                                <ul class="nav navbar-nav nav-font" >
                                    <li ><a  href="Admin Front Page.html">Home</a></li>
                                    <li><a href="Admin%20Front page.html#aboutUs" >about us</a></li>							
                                    <li class="dropdown">
                                    ...
                                    <li><a href="Admin%20Front page.html#team"  >team</a></li>
                                    <li><a href="Admin%20Front page.html#gallery" >gallery</a></li>
                                    <li><a href="Admin%20Front page.html#contactUs" >Contact</a></li>	
        ...
        <form method="post" action = "Admin%20Information.php">
                    ...
                    <div class="container">
                        <div class="row">           
                            ...
                            <div class="col-md-6"  >
                                ...
                                <button class="btn btn-primary" name="view" style="float:right;">EDIT</button>
                            </div>
